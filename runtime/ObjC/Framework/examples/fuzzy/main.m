...
int main(int argc, const char * argv[])
{
	...
	NSString *input = [NSString stringWithContentsOfFile:@"/Users/acondit/source/antlr/code/antlr/runtime/ObjC/Framework/examples/fuzzy/input"  encoding:NSASCIIStringEncoding error:&error];
	NSLog(@"%@", input);
