...
int main()
{
	...
	NSString *string = [NSString stringWithContentsOfFile:@"/Users/acondit/source/antlr/code/antlr/runtime/ObjC/Framework/examples/LL-star/input" encoding:NSASCIIStringEncoding error:&error];
